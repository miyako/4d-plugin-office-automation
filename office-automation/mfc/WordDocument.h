...
// WordDocument wrapper class

class WordDocument : public COleDispatchDriver
{
public:
	WordDocument() {} // Calls COleDispatchDriver default constructor
	WordDocument(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordDocument(const WordDocument& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
