#ifndef EXCEL_WORKBOOK_H
#define EXCEL_WORKBOOK_H

// Machine generated IDispatch wrapper class(es) created with Add Class from Typelib Wizard

// ExcelWorkbook wrapper class

class ExcelWorkbook : public COleDispatchDriver
{
public:
	ExcelWorkbook() {} // Calls COleDispatchDriver default constructor
	ExcelWorkbook(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	ExcelWorkbook(const ExcelWorkbook& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
