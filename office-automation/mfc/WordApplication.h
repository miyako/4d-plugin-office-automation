...
// WordApplication wrapper class

class WordApplication : public COleDispatchDriver
{
public:
	WordApplication() {} // Calls COleDispatchDriver default constructor
	WordApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordApplication(const WordApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
