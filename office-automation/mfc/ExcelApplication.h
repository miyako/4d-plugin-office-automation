...
// ExcelApplication wrapper class

class ExcelApplication : public COleDispatchDriver
{
public:
	ExcelApplication() {} // Calls COleDispatchDriver default constructor
	ExcelApplication(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	ExcelApplication(const ExcelApplication& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
