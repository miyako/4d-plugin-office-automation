...
// WordDocuments wrapper class

class WordDocuments : public COleDispatchDriver
{
public:
	WordDocuments() {} // Calls COleDispatchDriver default constructor
	WordDocuments(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	WordDocuments(const WordDocuments& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
