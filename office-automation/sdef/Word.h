...
- (WordWdCharacterCase) case;  // Returns or sets a constant that represents the case of the text in the text range.
- (void) setCase: (WordWdCharacterCase)_case;
