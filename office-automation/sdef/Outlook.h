...
@class OutlookItem, OutlookWindow, OutlookApplication, OutlookMainWindow, OutlookDraftWindow, OutlookObject, OutlookCategorizableObject, OutlookTodoableObject, OutlookFolder, OutlookCategory, OutlookContactsPanel, OutlookDirectorySource, OutlookAttachment, OutlookAlertsCenter, OutlookNavigationNode, OutlookItemListNode, OutlookAccount, OutlookExchangeAccount, OutlookPopAccount, OutlookImapAccount, OutlookLdapAccount, OutlookDelegatedAccount, OutlookOtherUsersFolderAccount, OutlookRecipient, OutlookMailFolder, OutlookMessage, OutlookIncomingMessage, OutlookOutgoingMessage, OutlookToRecipient, OutlookCcRecipient, OutlookBccRecipient, OutlookMeetingMessage, OutlookAddressBook, OutlookContact, OutlookGroup, OutlookCalendar, OutlookCalendarEvent, OutlookAttendee, OutlookRequiredAttendee, OutlookOptionalAttendee, OutlookResourceAttendee, OutlookTaskFolder, OutlookTask, OutlookNoteFolder, OutlookNote, OutlookSignature, OutlookDebugTest, OutlookUnitTest, OutlookImapFolder;
...
enum OutlookProductActivationState {
	...
	OutlookProductActivationStateReducedFunctionalityNeverActivated = 'pRFM' /* Outlook has not been activated, so you can't send mail. */,
	OutlookProductActivationStateReducedFunctionalityDeactivated = 'pRFD' /* Your Office license is expired or inactive. You can't send mail messages without an active license. */,
	OutlookProductActivationStateOfflineDemo = 'pOFD' /* Your Office license currently does not allow you to send mail. */
};
...
enum OutlookRole {
	OutlookRoleNoRole = 'frNR',
	OutlookRoleOwner = 'frOW',
	OutlookRolePublishingEditor = 'frPE',
	OutlookRoleEditor = 'frED',
	OutlookRolePublishingAuthor = 'frPA',
	OutlookRoleAuthor = 'frAU',
	OutlookRoleNoneditingAuthor = 'frNA',
	OutlookRoleReviewer = 'frRE',
	OutlookRoleContributor = 'frCO',
	OutlookRoleFreebusyTimeOnly = 'frFB',
	OutlookRoleFreebusyAndSubjectAndLocation = 'frMI',
	OutlookRoleCustomRole = 'frCU'
};
typedef enum OutlookRole OutlookRole;

enum OutlookEditLevel {
	OutlookEditLevelEditNone = 'fpEN',
	OutlookEditLevelEditOwn = 'fpEO',
	OutlookEditLevelEditAll = 'fpEA'
};
typedef enum OutlookEditLevel OutlookEditLevel;

enum OutlookReadLevel {
	OutlookReadLevelReadNone = 'fpRN',
	OutlookReadLevelReadFreebusy = 'fpFB',
	OutlookReadLevelReadCalendarSummary = 'fpCS',
	OutlookReadLevelReadAll = 'fpRA'
};
typedef enum OutlookReadLevel OutlookReadLevel;

enum OutlookPermissionsUserType {
	OutlookPermissionsUserTypeNormalUser = 'utNU',
	OutlookPermissionsUserTypeAnonymousUser = 'utAU',
	OutlookPermissionsUserTypeDefaultUser = 'utDU'
};
typedef enum OutlookPermissionsUserType OutlookPermissionsUserType;

enum OutlookSharedMailboxType {
	OutlookSharedMailboxTypeInboxFolder = 'astI',
	OutlookSharedMailboxTypeCalendarFolder = 'astC',
	OutlookSharedMailboxTypeAddressBookFolder = 'astA'
};
typedef enum OutlookSharedMailboxType OutlookSharedMailboxType;

enum OutlookDelegatePermission {
	OutlookDelegatePermissionNoneDelegatePermission = 'dpNo',
	OutlookDelegatePermissionEditorDelegatePermission = 'dpEd',
	OutlookDelegatePermissionReviewerDelegatePermission = 'dpRe',
	OutlookDelegatePermissionAuthorDelegatePermission = 'dpAu',
	OutlookDelegatePermissionCustomDelegatePermission = 'dpCu' /* You can't set any permission as custom using this command */
};
typedef enum OutlookDelegatePermission OutlookDelegatePermission;
...
- (SBElementArray<OutlookAddressBook *> *) addressBooks;
- (SBElementArray<OutlookCalendar *> *) calendars;
- (SBElementArray<OutlookCalendarEvent *> *) calendarEvents;
- (SBElementArray<OutlookCategory *> *) categories;
- (SBElementArray<OutlookContact *> *) contacts;
- (SBElementArray<OutlookDraftWindow *> *) draftWindows;
- (SBElementArray<OutlookExchangeAccount *> *) exchangeAccounts;
- (SBElementArray<OutlookFolder *> *) folders;
- (SBElementArray<OutlookGroup *> *) groups;
- (SBElementArray<OutlookImapAccount *> *) imapAccounts;
- (SBElementArray<OutlookIncomingMessage *> *) incomingMessages;
- (SBElementArray<OutlookLdapAccount *> *) ldapAccounts;
- (SBElementArray<OutlookMailFolder *> *) mailFolders;
- (SBElementArray<OutlookMainWindow *> *) mainWindows;
- (SBElementArray<OutlookMessage *> *) messages;
- (SBElementArray<OutlookNote *> *) notes;
- (SBElementArray<OutlookNoteFolder *> *) noteFolders;
- (SBElementArray<OutlookOutgoingMessage *> *) outgoingMessages;
- (SBElementArray<OutlookPopAccount *> *) popAccounts;
- (SBElementArray<OutlookTask *> *) tasks;
- (SBElementArray<OutlookTaskFolder *> *) taskFolders;
- (SBElementArray<OutlookSignature *> *) signatures;
- (SBElementArray<OutlookWindow *> *) windows;

@property (copy, readonly) NSArray<OutlookMessage *> *currentMessages;  // The current messages depending on the context.
...
@property (copy) NSArray<OutlookObject *> *selectedObjects;  // The list of objects that are currently selected in the frontmost main window.
...
- (NSArray<NSDictionary *> *) expand:(id)x exchangeAccount:(OutlookExchangeAccount *)exchangeAccount;  // Queries DL expansion information for a distribution list.
...
- (NSArray<OutlookContact *> *) importVcf:(NSURL *)x to:(SBObject *)to;  // Import a vcf file.
- (void) goTo:(NSDate *)x;  // Switches the current calendar view to the date specified.
- (NSArray<OutlookObject *> *) importIcs:(NSURL *)x to:(SBObject *)to;  // Import an ics file.
...
- (SBElementArray<OutlookNavigationNode *> *) navigationNodes;
- (SBElementArray<OutlookObject *> *) objects;
- (SBElementArray<OutlookItemListNode *> *) itemListNodes;
...
@property (copy) NSArray<OutlookCategory *> *categories;  // The categories of an categorizable object.
...
- (SBElementArray<OutlookDirectorySource *> *) directorySources;
- (SBElementArray<OutlookContact *> *) contacts;
...
@property (copy, readonly) OutlookMailFolder *rootFolder;  // The root folder of an account.
...
- (SBElementArray<OutlookDelegatedAccount *> *) delegatedAccounts;
- (SBElementArray<OutlookOtherUsersFolderAccount *> *) otherUsersFolderAccounts;
...
- (NSDictionary *) queryFolderSizeFolder:(OutlookFolder *)folder;
- (NSArray<NSDictionary *> *) queryFolderPermissionsFolder:(OutlookFolder *)folder;
- (void) setFolderPermissionsFolder:(OutlookFolder *)folder newUsers:(NSArray<NSDictionary *> *)newUsers;
- (NSDictionary *) queryAutoreplyData;
- (void) setAutoreplyDataNewData:(NSDictionary *)newData;
- (NSNumber *) verifyMailboxMailbox:(OutlookSharedMailboxType)mailbox userAddress:(NSString *)userAddress;
...
- (SBElementArray<OutlookIncomingMessage *> *) incomingMessages;
- (SBElementArray<OutlookOutgoingMessage *> *) outgoingMessages;
- (SBElementArray<OutlookMeetingMessage *> *) meetingMessages;
...
- (SBElementArray<OutlookRecipient *> *) recipients;
- (SBElementArray<OutlookToRecipient *> *) toRecipients;
- (SBElementArray<OutlookCcRecipient *> *) ccRecipients;
- (SBElementArray<OutlookBccRecipient *> *) bccRecipients;
- (SBElementArray<OutlookAttachment *> *) attachments;
...
- (NSArray<NSDictionary *> *) expandExchangeAccount:(OutlookExchangeAccount *)exchangeAccount;  // Queries DL expansion information for a distribution list.
...
- (SBElementArray<OutlookAttendee *> *) attendees;
- (SBElementArray<OutlookRequiredAttendee *> *) requiredAttendees;
- (SBElementArray<OutlookOptionalAttendee *> *) optionalAttendees;
- (SBElementArray<OutlookResourceAttendee *> *) resourceAttendees;
- (SBElementArray<OutlookAttachment *> *) attachments;
